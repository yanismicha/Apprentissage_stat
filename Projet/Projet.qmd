...
On peut donc conclure que dans la majorité des cas d'utilisation de l'ACP permet aux algorithmes une meilleure détection des anomalie ce-ci n'est pas forcément vrais pour tous les algorithmes. On conclura que le SVM avec ACP est le meilleur algorithme de détection d'anomalie pour notre jeu de donnée. Même si l'AUC du modèle Gaussien est supérieur à celui du SVM, le SVM à une accuracy bien supérieur.
