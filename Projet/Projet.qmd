...
Ce rapport cherche à évaluer diverses méthodes de détection d'anomalies, sur un jeu de donnée comportent `r nrow(X)` observations et `r ncol(X)` dimensions. Il comporte `r temp[1]` observations normales et `r temp[2]` outliers.
